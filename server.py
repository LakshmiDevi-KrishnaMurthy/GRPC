...
class MetadataService(metadata_pb2_grpc.MetadataServicer):
    ...
    metaDataMap = {'english_song.mp3': ["127.0.0.1", 60000],
                   'english_rhyme.mp3': ["127.0.0.1", 60000],
                   'hindi_song.mp3': ["127.0.0.1", 60001],
                   'telugu_song.mp3': ["127.0.0.1", 60001],
                   'tamil_song.mp3': ["127.0.0.1", 60002]}
...
def serve():
    ...
    server.add_insecure_port("[::]:60009")
